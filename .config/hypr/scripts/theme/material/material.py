...
SCRIPTS_DIR = f"{HOME_DIR}/.config//hypr/scripts/theme/material/"
...
def setup(img):
    ...
    os.system("gradience-cli apply -p ~/.config/hypr/scripts/theme/material/colors/colors-gradience.json --gtk both")
